...
O agente coleta os dados de CPU do host monitorado.
O servidor de monitoramento recebe as métricas enviadas pelo agente.
A trigger avalia os valores recebidos em tempo real.
Quando o limite configurado é ultrapassado, a condição da trigger é atendida.
Um alerta é gerado pelo Zabbix.
O dashboard exibe o problema, com severidade e detalhes do evento.
A equipe de TI inicia a investigação a partir das informações disponibilizadas.
...
Nesta parte é demonstrado os containers do zabbix e a CPU estressada para simular o estudo de caso
